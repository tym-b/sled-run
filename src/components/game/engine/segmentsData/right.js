...
export const objects = [
  [
    ...
    { type: 'coin', position: { x: 50, z: 2, y: 80 }, rotation: 0 },
    { type: 'tree', position: { x: 40, y: 180 }, rotation: 0 },
    { type: 'tree', position: { x: 40, y: 100 }, rotation: -45 },
    { type: 'tree', position: { x: 35, y: 105 }, rotation: -45 },
    { type: 'snowdrift', position: { x: 80, y: 110 }, rotation: 0 },
  ],
  [
    ...
    { type: 'snowdrift', position: { x: 45, y: 140 }, rotation: 0 },
    { type: 'snowdrift', position: { x: 85, y: 170 }, rotation: 0 },
