export const objectsData = [
  ...
  { type: 'rock', position: { x: 76.396, y: 195.541 }, rotation: -175.817 },
  { type: 'rock', position: { x: -38.4226, y: 105.338 }, rotation: -112.319 },
  { type: 'rock', position: { x: 104.05, y: 83.1658 }, rotation: 25.6042 },
  { type: 'rock', position: { x: 41.4711, y: 0 }, rotation: -90 },
  { type: 'smallRock', position: { x: 72.6721, y: 62.4776 }, rotation: -128.502 },
  ...
  { type: 'smallRock', position: { x: -41.2053, y: 33.0846 }, rotation: -95.5863 },
];
